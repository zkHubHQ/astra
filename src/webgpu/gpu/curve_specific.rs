...
use super::wgsl::{
    BLS12_377_CURVE_BASE_WGSL, BLS12_377_PARAMS_WGSL, BN254_CURVE_BASE_WGSL, BN254_CURVE_HALO2_BASE_WGSL, BN254_PARAMS_WGSL, UGLY_BN254_CURVE_HALO2_BASE_WGSL, UGLY_BN254_PARAMS_WGSL
};
...
pub fn get_ugly_curve_params_wgsl(curve: CurveType) -> &'static str {
    match curve {
        CurveType::BLS12_377 => BLS12_377_PARAMS_WGSL,
        CurveType::BN254 => UGLY_BN254_PARAMS_WGSL,
    }
}
...
pub fn get_ugly_curve_base_functions_wgsl(curve: CurveType) -> &'static str {
    match curve {
        CurveType::BLS12_377 => BLS12_377_CURVE_BASE_WGSL,
        CurveType::BN254 => UGLY_BN254_CURVE_HALO2_BASE_WGSL,
    }
}
